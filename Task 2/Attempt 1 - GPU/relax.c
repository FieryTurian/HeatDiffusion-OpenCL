...
int main()
{
   ...
   if (err == CL_SUCCESS) {
      ...
      kernels = setupKernel(KernelSource, "relax", 5, DoubleArr, n, a, DoubleArr, n, b, BoolArr, n, stable, DoubleConst, EPS, IntConst, n);
