...
/*******************************************************************************
 *
 * host2devBoolArr : transfers "n" elements of the bool array "a" on the host
 *                   to the device buffer at "ad".
 *
 ******************************************************************************/
...
extern kernel_struct setupKernel( const char *kernel_source, char *kernel_name, size_t local, int num_args, ...);
